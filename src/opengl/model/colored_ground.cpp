#include <gtools/opengl/model/colored_ground.hpp>

#include <gtools/structures_pack/vertex_uv.hpp>
...
namespace gtools {
  namespace opengl {
    namespace model {
      ...
      void colored_ground::gl_support::anime( const gtools::time& t )
      {
      ...
      void colored_ground::anime( const gtools::time& t )
      {
        if( gl_support_up )
