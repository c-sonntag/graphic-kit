...
namespace graphic_toolkit {
  ...
  qt_easiest_matrice_controler::qt_easiest_matrice_controler( QWidget * parent ) :
    QWidget( parent ),
  ...
  qt_easiest_matrice_controler::~qt_easiest_matrice_controler()
  {
    delete ui;
  }
  ...
  inline qt_easiest_matrice_controler::locker_repaint_glcanvas::locker_repaint_glcanvas( qt_easiest_matrice_controler * const _emc_p ) :
  ...
  inline qt_easiest_matrice_controler::locker_repaint_glcanvas::~locker_repaint_glcanvas()
  {
    if ( can_unlock )
    {
  ...
  void qt_easiest_matrice_controler::init_after_gl( QOpenGLWidget * _glwidget )
  {
    glwidget = _glwidget;
  ...
  void qt_easiest_matrice_controler::repaint_glcanvas( bool force )
  {
  ...
  void qt_easiest_matrice_controler::refresh_form()
  {
  ...
  void qt_easiest_matrice_controler::on_radioButton_viewOrtho_clicked()
  {
  ...
  void qt_easiest_matrice_controler::on_radioButton_viewPerspective_clicked()
  {
  ...
  void qt_easiest_matrice_controler::on_doubleSpinBox_fov_valueChanged( double value )
  {
    set_fov_only( float( value ) );
  }

  void qt_easiest_matrice_controler::on_doubleSpinBox_zoom_valueChanged( double value )
  {
    set_zoom_only( float( value ) );
  }

  void qt_easiest_matrice_controler::on_radioButton_freeView_clicked()
  {
    change_displacement_only( DisplacementMode::FreeView );
  }

  void qt_easiest_matrice_controler::on_radioButton_freeCamera_clicked()
  {
    change_displacement_only( DisplacementMode::FreeCamera );
  }

  void qt_easiest_matrice_controler::on_radioButton_freeView_timerRotation_clicked()
  {
    change_displacement_only( DisplacementMode::FreeView_TimerRotation );
  }

  void qt_easiest_matrice_controler::on_pushButton_resetView_clicked()
  {
    reset_view();
  }
  ...
  void qt_easiest_matrice_controler::reset_view()
  {
    //camera_angle = QVector2D( 0.f, 0.f );
    camera_angle = QVector2D( pi, 0.f );
    camera_position = QVector3D( 0.f, 0.f, default_z );
  ...
  void qt_easiest_matrice_controler::compute_camera()
  {
  ...
  void qt_easiest_matrice_controler::compute_projection()
  {
  ...
  void qt_easiest_matrice_controler::receive_resize( int w, int h )
  {
    //
  ...
  void qt_easiest_matrice_controler::receive_mousePressEvent( QMouseEvent * e )
  {
  ...
  void qt_easiest_matrice_controler::receive_mouseReleaseEvent( QMouseEvent * e )
  {
    if ( mouse_tracking )
    {
      QCursor c = cursor();
  ...
  void qt_easiest_matrice_controler::receive_mouseMoveEvent( QMouseEvent * e )
  {
    //
  ...
  void qt_easiest_matrice_controler::timer_start()
  {
  ...
  void qt_easiest_matrice_controler::timer_stop()
  {
    timer.stop();
  }

  void qt_easiest_matrice_controler::timerEvent( QTimerEvent * e )
  {
    //
    if ( displacement_mode == DisplacementMode::FreeView_TimerRotation )
  ...
  bool qt_easiest_matrice_controler::eventFilter( QObject * o, QEvent * event )
  {
  ...
  bool qt_easiest_matrice_controler::want_rotation() const
  {
  ...
  void qt_easiest_matrice_controler::compute_mouseMove_freeView( const QMouseEvent * e, const QVector2D & diff )
  {
    if ( want_rotation() )
    {
      //
  ...
  void qt_easiest_matrice_controler::compute_mouseMove_freeCamera( const QMouseEvent * e, const QVector2D & diff )
  {
    if ( want_rotation() )
      compute_mouseMove_freeView( e, diff );
  ...
  void qt_easiest_matrice_controler::compute_mouseMove_freeView_and_timerRotation( const QMouseEvent * e, const QVector2D & diff )
  {
    if ( !want_rotation() )
      compute_mouseMove_freeView( e, diff );
  }

  void qt_easiest_matrice_controler::compute_mouseRelease_freeView_and_timerRotation( const QMouseEvent *, const QVector2D & diff )
  {
    if ( want_rotation() )
    {
  ...
  void qt_easiest_matrice_controler::compute_timer_freeView_and_timerRotation( const QTimerEvent * )
  {
  ...
  bool qt_easiest_matrice_controler::compute_keyboard_freeView( const QKeyEvent * )
  {
    return false;
  }

  bool qt_easiest_matrice_controler::compute_keyboard_freeCamera( const QKeyEvent * e )
  {
    //if ( !e->isAutoRepeat() )
    //  return false;
  ...
  void qt_easiest_matrice_controler::change_displacement( DisplacementMode mode )
  {
  ...
  void qt_easiest_matrice_controler::change_displacement_only( DisplacementMode mode )
  {
  ...
  void qt_easiest_matrice_controler::change_displacement_inverted_rotation_move_touch( bool value )
  {
  ...
  void qt_easiest_matrice_controler::change_projection( ProjectionMode mode )
  {
  ...
  void qt_easiest_matrice_controler::set_fov( float value )
  {
    set_fov_only( value );
    ui->doubleSpinBox_fov->setValue( double( fov ) );
  }

  void qt_easiest_matrice_controler::set_zoom( float value )
  {
    set_zoom_only( value );
  ...
  void qt_easiest_matrice_controler::change_projection_only( ProjectionMode mode )
  {
    locker_repaint_glcanvas locker( this );
  ...
  void qt_easiest_matrice_controler::set_fov_only( float value )
  {
    locker_repaint_glcanvas locker( this );
  ...
  void qt_easiest_matrice_controler::set_zoom_only( float value )
  {
    locker_repaint_glcanvas locker( this );
