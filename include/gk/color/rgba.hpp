...
#pragma GCC diagnostic ignored "-Wpedantic"
    ...
    struct rgb
    {
      ...
      constexpr inline rgb( int _red, int _green, int _blue ) : red( uint8_t( _red ) ), green( uint8_t( _green ) ), blue( uint8_t( _blue ) ) {}
    ...
    struct rgba
    {
      ...
      constexpr inline rgba( const int _red, const int _green, const int _blue, const int _alpha = 255 ) : red( uint8_t( _red ) ), green( uint8_t( _green ) ), blue( uint8_t( _blue ) ), alpha( uint8_t( _alpha ) ) {}
