...
inline glm::mat4 operator *( const gtools::matrices::abstract& lhs, const glm::mat4& rhs )                  { return lhs.m * rhs; }
inline glm::mat4 operator *( const glm::mat4& lhs, const gtools::matrices::abstract& rhs )                  { return lhs * rhs.m; }
inline glm::mat4 operator *( const gtools::matrices::abstract& lhs, const gtools::matrices::abstract& rhs ) { return lhs.m * rhs.m; }
inline glm::mat4 operator /( const gtools::matrices::abstract& lhs, const glm::mat4& rhs )                  { return lhs.m / rhs; }
inline glm::mat4 operator /( const glm::mat4& lhs, const gtools::matrices::abstract& rhs )                  { return lhs / rhs.m; }
inline glm::mat4 operator /( const gtools::matrices::abstract& lhs, const gtools::matrices::abstract& rhs ) { return lhs.m / rhs.m; }
inline glm::mat4 operator +( const gtools::matrices::abstract& lhs, const glm::mat4& rhs )                  { return lhs.m + rhs; }
