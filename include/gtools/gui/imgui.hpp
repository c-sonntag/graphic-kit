...
namespace gtools {
  namespace gui {
    namespace imgui {
      ...
      namespace matrices {
        bool projection( gtools::matrices::projection& projection, const char* const node_name = "Projection" );
        bool view( gtools::matrices::view_lookat& view, const char* const node_name = "LookAt" );
        bool model( gtools::matrices::model& model, const char* const node_name = "Model" );
      }
