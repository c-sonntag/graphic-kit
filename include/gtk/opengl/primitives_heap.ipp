...
#include <gtk/opengl/primitives_heap/vertex_expander.hpp>
#include <gtk/opengl/primitives_heap/index_expander.hpp>
#include <gtk/opengl/primitives_heap/uniform_lap.hpp>
...
namespace gtk {
  namespace opengl {
    ...
    template< typename ... TListTypes >
    inline void primitives_heap<TListTypes ...>::configure_vao( raiigl::gl330& gl )
    {
    ...
    inline void primitives_heap<TListTypes ...>::draw( raiigl::gl330& gl, raiigl::program& program )
    {
      ...
      /** @todo aplly specialization Opengl 430 or 330 */
      ...
      //
      raiigl::buffer::unbind_all_binded_buffer_type();
