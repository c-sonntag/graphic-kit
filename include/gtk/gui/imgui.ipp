  ...
  namespace gui {
    namespace imgui {
      ...
      namespace matrices {
        ...
        inline bool projection( gtk::matrices::projection& projection, const char* const node_name )
        {
          bool change( false );
        ...
        inline bool view( gtk::matrices::view_lookat& view, const char* const node_name )
        {
          bool change( false );
          if( ImGui::TreeNode( node_name ) )
          {
        ...
        inline bool model( gtk::matrices::model& model, const char* const node_name )
        {
          bool change( false );
          if( ImGui::TreeNode( node_name ) )
          {
